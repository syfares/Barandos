...
This mechanism has been integrated into Bitcore-Node-barandos which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/barandos-crypto/insight-api-barandos#web-socket-api](https://github.com/barandos-crypto/insight-api-barandos#web-socket-api) 
* API: [https://github.com/barandos-crypto/insight-api-barandos#swifttx-transactions](https://github.com/barandos-crypto/insight-api-barandos#swifttx-transactions) 
...
By default, the barandos Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the barandos Core daemon:
