/* src/config/barandos-config.h.  Generated from barandos-config.h.in by configure.  */
/* src/config/barandos-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef BARA_CONFIG_H

#define BARA_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.barandos.com"

/* Define to the full name of this package. */
#define PACKAGE_NAME "barandos Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "barandos Core 1.3.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "barandos"
