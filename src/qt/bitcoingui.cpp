                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("barandos Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a barandos address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and barandos: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About barandos Core"), this);
    aboutAction->setStatusTip(tr("Show information about barandos Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for barandos"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your barandos addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified barandos addresses"));
    ...
    openAction->setStatusTip(tr("Open a barandos: URI or payment request"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the barandos Core help message to get a list with possible barandos command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("barandos Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to barandos network", "", count));
}
...
{
    QString strTitle = tr("barandos Core"); // default title
