...
#include "qt/qtmaterialflatbutton_internal.h"
...
void QtMaterialFlatButtonStateMachine::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QtMaterialFlatButtonStateMachine::buttonPressed)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (QtMaterialFlatButtonStateMachine::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QtMaterialFlatButtonStateMachine::buttonChecked)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (QtMaterialFlatButtonStateMachine::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QtMaterialFlatButtonStateMachine::buttonUnchecked)) {
                *result = 2;
                return;
            }
        }
...
const QMetaObject QtMaterialFlatButtonStateMachine::staticMetaObject = {
    { &QStateMachine::staticMetaObject, qt_meta_stringdata_QtMaterialFlatButtonStateMachine.data,
      qt_meta_data_QtMaterialFlatButtonStateMachine,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QtMaterialFlatButtonStateMachine::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QtMaterialFlatButtonStateMachine.stringdata0))
        return static_cast<void*>(const_cast< QtMaterialFlatButtonStateMachine*>(this));
