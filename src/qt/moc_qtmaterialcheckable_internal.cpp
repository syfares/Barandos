...
#include "qt/qtmaterialcheckable_internal.h"
...
void QtMaterialCheckableIcon::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::ReadProperty) {
        QtMaterialCheckableIcon *_t = static_cast<QtMaterialCheckableIcon *>(_o);
        Q_UNUSED(_t)
        void *_v = _a[0];
        switch (_id) {
...
const QMetaObject QtMaterialCheckableIcon::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_QtMaterialCheckableIcon.data,
      qt_meta_data_QtMaterialCheckableIcon,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QtMaterialCheckableIcon::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QtMaterialCheckableIcon.stringdata0))
        return static_cast<void*>(const_cast< QtMaterialCheckableIcon*>(this));
