...
void QtMaterialRipple::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        QtMaterialRipple *_t = static_cast<QtMaterialRipple *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject QtMaterialRipple::staticMetaObject = {
    { &QParallelAnimationGroup::staticMetaObject, qt_meta_stringdata_QtMaterialRipple.data,
      qt_meta_data_QtMaterialRipple,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QtMaterialRipple::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QtMaterialRipple.stringdata0))
        return static_cast<void*>(const_cast< QtMaterialRipple*>(this));
