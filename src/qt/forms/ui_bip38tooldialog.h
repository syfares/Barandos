...
public:
    ...
    QtMaterialFlatButton *addressBookButton_ENC;
    QtMaterialFlatButton *pasteButton_ENC;
    ...
    QtMaterialFlatButton *copyKeyButton_ENC;
    QHBoxLayout *horizontalLayout_3_ENC;
    QtMaterialFlatButton *encryptKeyButton_ENC;
    QtMaterialFlatButton *clearButton_ENC;
    ...
    QtMaterialFlatButton *decryptKeyButton_DEC;
    QtMaterialFlatButton *clearButton_DEC;
    ...
    QtMaterialFlatButton *importAddressButton_DEC;
    QLabel *label_4;
    ...
    void setupUi(QDialog *Bip38ToolDialog)
    {
        ...
        addressBookButton_ENC = new QtMaterialFlatButton(tabBip38Encrypt);
        ...
        addressBookButton_ENC->setProperty("icon", QVariant(icon));
        addressBookButton_ENC->setProperty("autoDefault", QVariant(false));

        horizontalLayout_1_ENC->addWidget(addressBookButton_ENC);

        pasteButton_ENC = new QtMaterialFlatButton(tabBip38Encrypt);
        ...
        pasteButton_ENC->setProperty("icon", QVariant(icon1));
        pasteButton_ENC->setProperty("autoDefault", QVariant(false));
        ...
        copyKeyButton_ENC = new QtMaterialFlatButton(tabBip38Encrypt);
        ...
        copyKeyButton_ENC->setProperty("icon", QVariant(icon2));
        copyKeyButton_ENC->setProperty("autoDefault", QVariant(false));
        ...
        encryptKeyButton_ENC = new QtMaterialFlatButton(tabBip38Encrypt);
        ...
        encryptKeyButton_ENC->setProperty("icon", QVariant(icon3));
        encryptKeyButton_ENC->setProperty("autoDefault", QVariant(false));

        horizontalLayout_3_ENC->addWidget(encryptKeyButton_ENC);

        clearButton_ENC = new QtMaterialFlatButton(tabBip38Encrypt);
        ...
        clearButton_ENC->setProperty("icon", QVariant(icon4));
        clearButton_ENC->setProperty("autoDefault", QVariant(false));
        ...
        decryptKeyButton_DEC = new QtMaterialFlatButton(tabBip38Decrypt);
        ...
        decryptKeyButton_DEC->setProperty("icon", QVariant(icon5));
        decryptKeyButton_DEC->setProperty("autoDefault", QVariant(false));

        horizontalLayout_2_DEC->addWidget(decryptKeyButton_DEC);

        clearButton_DEC = new QtMaterialFlatButton(tabBip38Decrypt);
        clearButton_DEC->setObjectName(QStringLiteral("clearButton_DEC"));
        clearButton_DEC->setProperty("icon", QVariant(icon4));
        clearButton_DEC->setProperty("autoDefault", QVariant(false));
        ...
        importAddressButton_DEC = new QtMaterialFlatButton(tabBip38Decrypt);
    ...
    void retranslateUi(QDialog *Bip38ToolDialog)
    {
        ...
        infoLabel_ENC->setText(QApplication::translate("Bip38ToolDialog", "Enter a barandos Address that you would like to encrypt using BIP 38. Enter a passphrase in the middle box. Press encrypt to compute the encrypted private key.", Q_NULLPTR));
        label_5->setText(QApplication::translate("Bip38ToolDialog", "Address:", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        addressIn_ENC->setToolTip(QApplication::translate("Bip38ToolDialog", "The barandos address to sign the message with", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        addressBookButton_ENC->setToolTip(QApplication::translate("Bip38ToolDialog", "Choose previously used address", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        addressBookButton_ENC->setProperty("text", QVariant(QString()));
        addressBookButton_ENC->setProperty("shortcut", QVariant(QApplication::translate("Bip38ToolDialog", "Alt+A", Q_NULLPTR)));
#ifndef QT_NO_TOOLTIP
        pasteButton_ENC->setToolTip(QApplication::translate("Bip38ToolDialog", "Paste address from clipboard", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        pasteButton_ENC->setProperty("text", QVariant(QString()));
        pasteButton_ENC->setProperty("shortcut", QVariant(QApplication::translate("Bip38ToolDialog", "Alt+P", Q_NULLPTR)));
...
#endif // QT_NO_TOOLTIP
        copyKeyButton_ENC->setProperty("text", QVariant(QString()));
#ifndef QT_NO_TOOLTIP
        encryptKeyButton_ENC->setToolTip(QApplication::translate("Bip38ToolDialog", "Sign the message to prove you own this barandos address", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        encryptKeyButton_ENC->setProperty("text", QVariant(QApplication::translate("Bip38ToolDialog", "Encrypt Key", Q_NULLPTR)));
#ifndef QT_NO_TOOLTIP
        clearButton_ENC->setToolTip(QApplication::translate("Bip38ToolDialog", "Reset all sign message fields", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        clearButton_ENC->setProperty("text", QVariant(QApplication::translate("Bip38ToolDialog", "Clear All", Q_NULLPTR)));
...
#ifndef QT_NO_TOOLTIP
        encryptedKeyIn_DEC->setToolTip(QApplication::translate("Bip38ToolDialog", "The barandos address the message was signed with", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        label->setText(QApplication::translate("Bip38ToolDialog", "Passphrase: ", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        decryptKeyButton_DEC->setToolTip(QApplication::translate("Bip38ToolDialog", "Verify the message to ensure it was signed with the specified barandos address", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        decryptKeyButton_DEC->setProperty("text", QVariant(QApplication::translate("Bip38ToolDialog", "Decrypt Key", Q_NULLPTR)));
#ifndef QT_NO_TOOLTIP
        clearButton_DEC->setToolTip(QApplication::translate("Bip38ToolDialog", "Reset all verify message fields", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        clearButton_DEC->setProperty("text", QVariant(QApplication::translate("Bip38ToolDialog", "Clear All", Q_NULLPTR)));
        statusLabel_DEC->setText(QString());
        label_3->setText(QApplication::translate("Bip38ToolDialog", "Decrypted Key:", Q_NULLPTR));
        importAddressButton_DEC->setProperty("text", QVariant(QApplication::translate("Bip38ToolDialog", "Import Address", Q_NULLPTR)));
