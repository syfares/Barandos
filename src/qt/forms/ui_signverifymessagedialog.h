...
public:
    ...
    QtMaterialFlatButton *addressBookButton_SM;
    QtMaterialFlatButton *pasteButton_SM;
    QPlainTextEdit *messageIn_SM;
    QLabel *signatureLabel_SM;
    QHBoxLayout *horizontalLayout_2_SM;
    QLineEdit *signatureOut_SM;
    QtMaterialFlatButton *copySignatureButton_SM;
    QHBoxLayout *horizontalLayout_3_SM;
    QtMaterialFlatButton *signMessageButton_SM;
    QtMaterialFlatButton *clearButton_SM;
    ...
    QtMaterialFlatButton *addressBookButton_VM;
    QPlainTextEdit *messageIn_VM;
    QValidatedLineEdit *signatureIn_VM;
    QHBoxLayout *horizontalLayout_2_VM;
    QtMaterialFlatButton *verifyMessageButton_VM;
    QtMaterialFlatButton *clearButton_VM;
    ...
    void setupUi(QDialog *SignVerifyMessageDialog)
    {
        ...
        addressBookButton_SM = new QtMaterialFlatButton(tabSignMessage);
        ...
        addressBookButton_SM->setProperty("icon", QVariant(icon));
        addressBookButton_SM->setProperty("autoDefault", QVariant(false));

        horizontalLayout_1_SM->addWidget(addressBookButton_SM);

        pasteButton_SM = new QtMaterialFlatButton(tabSignMessage);
        ...
        pasteButton_SM->setProperty("icon", QVariant(icon1));
        pasteButton_SM->setProperty("autoDefault", QVariant(false));
        ...
        copySignatureButton_SM = new QtMaterialFlatButton(tabSignMessage);
        ...
        copySignatureButton_SM->setProperty("icon", QVariant(icon2));
        copySignatureButton_SM->setProperty("autoDefault", QVariant(false));
        ...
        signMessageButton_SM = new QtMaterialFlatButton(tabSignMessage);
        ...
        signMessageButton_SM->setProperty("icon", QVariant(icon3));
        signMessageButton_SM->setProperty("autoDefault", QVariant(false));

        horizontalLayout_3_SM->addWidget(signMessageButton_SM);

        clearButton_SM = new QtMaterialFlatButton(tabSignMessage);
        ...
        clearButton_SM->setProperty("icon", QVariant(icon4));
        clearButton_SM->setProperty("autoDefault", QVariant(false));
        ...
        addressBookButton_VM = new QtMaterialFlatButton(tabVerifyMessage);
        addressBookButton_VM->setObjectName(QStringLiteral("addressBookButton_VM"));
        addressBookButton_VM->setProperty("icon", QVariant(icon));
        addressBookButton_VM->setProperty("autoDefault", QVariant(false));
        ...
        verifyMessageButton_VM = new QtMaterialFlatButton(tabVerifyMessage);
        ...
        verifyMessageButton_VM->setProperty("icon", QVariant(icon5));
        verifyMessageButton_VM->setProperty("autoDefault", QVariant(false));

        horizontalLayout_2_VM->addWidget(verifyMessageButton_VM);

        clearButton_VM = new QtMaterialFlatButton(tabVerifyMessage);
        clearButton_VM->setObjectName(QStringLiteral("clearButton_VM"));
        clearButton_VM->setProperty("icon", QVariant(icon4));
        clearButton_VM->setProperty("autoDefault", QVariant(false));
    ...
    void retranslateUi(QDialog *SignVerifyMessageDialog)
    {
        ...
        addressIn_SM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "The barandos address to sign the message with", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        addressBookButton_SM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "Choose previously used address", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        addressBookButton_SM->setProperty("text", QVariant(QString()));
        addressBookButton_SM->setProperty("shortcut", QVariant(QApplication::translate("SignVerifyMessageDialog", "Alt+A", Q_NULLPTR)));
#ifndef QT_NO_TOOLTIP
        pasteButton_SM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "Paste address from clipboard", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        pasteButton_SM->setProperty("text", QVariant(QString()));
        pasteButton_SM->setProperty("shortcut", QVariant(QApplication::translate("SignVerifyMessageDialog", "Alt+P", Q_NULLPTR)));
#ifndef QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
        copySignatureButton_SM->setProperty("text", QVariant(QString()));
#ifndef QT_NO_TOOLTIP
        signMessageButton_SM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "Sign the message to prove you own this barandos address", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        signMessageButton_SM->setProperty("text", QVariant(QApplication::translate("SignVerifyMessageDialog", "Sign Message", Q_NULLPTR)));
#ifndef QT_NO_TOOLTIP
        clearButton_SM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "Reset all sign message fields", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        clearButton_SM->setProperty("text", QVariant(QApplication::translate("SignVerifyMessageDialog", "Clear All", Q_NULLPTR)));
...
#ifndef QT_NO_TOOLTIP
        addressIn_VM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "The barandos address the message was signed with", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        addressBookButton_VM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "Choose previously used address", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        addressBookButton_VM->setProperty("text", QVariant(QString()));
        addressBookButton_VM->setProperty("shortcut", QVariant(QApplication::translate("SignVerifyMessageDialog", "Alt+A", Q_NULLPTR)));
#ifndef QT_NO_TOOLTIP
        verifyMessageButton_VM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "Verify the message to ensure it was signed with the specified barandos address", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        verifyMessageButton_VM->setProperty("text", QVariant(QApplication::translate("SignVerifyMessageDialog", "Verify Message", Q_NULLPTR)));
#ifndef QT_NO_TOOLTIP
        clearButton_VM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "Reset all verify message fields", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        clearButton_VM->setProperty("text", QVariant(QApplication::translate("SignVerifyMessageDialog", "Clear All", Q_NULLPTR)));
