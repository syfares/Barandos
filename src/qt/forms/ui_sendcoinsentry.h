...
public:
    ...
    void setupUi(QStackedWidget *SendCoinsEntry)
    {
        ...
        sizePolicy.setHeightForWidth(payTo->sizePolicy().hasHeightForWidth());
        payTo->setSizePolicy(sizePolicy);
        ...
        sizePolicy1.setHeightForWidth(addressBookButton->sizePolicy().hasHeightForWidth());
        addressBookButton->setSizePolicy(sizePolicy1);
        QIcon icon;
        ...
        sizePolicy1.setHeightForWidth(pasteButton->sizePolicy().hasHeightForWidth());
        pasteButton->setSizePolicy(sizePolicy1);
        QIcon icon1;
...
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        messageTextLabel->setToolTip(QApplication::translate("SendCoinsEntry", "A message that was attached to the barandos: URI which will be stored with the transaction for your reference. Note: This message will not be sent over the barandos network.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        payTo->setToolTip(QApplication::translate("SendCoinsEntry", "The barandos address to send the payment to", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
