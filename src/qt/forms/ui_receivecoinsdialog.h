...
public:
    ...
    QtMaterialFlatButton *receiveButton;
    ...
    QtMaterialFlatButton *showRequestButton;
    QtMaterialFlatButton *removeRequestButton;
    ...
    void setupUi(QWidget *ReceiveCoinsDialog)
    {
        ...
        receiveButton = new QtMaterialFlatButton(frame2);
        ...
        receiveButton->setProperty("icon", QVariant(icon));

        horizontalLayout->addWidget(receiveButton);

        clearButton = new QtMaterialFlatButton(frame2);
        ...
        showRequestButton = new QtMaterialFlatButton(frame);
        ...
        showRequestButton->setProperty("icon", QVariant(icon2));
        showRequestButton->setProperty("autoDefault", QVariant(false));

        horizontalLayout_2->addWidget(showRequestButton);

        removeRequestButton = new QtMaterialFlatButton(frame);
        removeRequestButton->setObjectName(QStringLiteral("removeRequestButton"));
        removeRequestButton->setEnabled(false);
        removeRequestButton->setProperty("icon", QVariant(icon1));
        removeRequestButton->setProperty("autoDefault", QVariant(false));
...
#ifndef QT_NO_TOOLTIP
        label_3->setToolTip(QApplication::translate("ReceiveCoinsDialog", "An optional message to attach to the payment request, which will be displayed when the request is opened. Note: The message will not be sent with the payment over the barandos network.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        reqMessage->setToolTip(QApplication::translate("ReceiveCoinsDialog", "An optional message to attach to the payment request, which will be displayed when the request is opened.<br>Note: The message will not be sent with the payment over the barandos network.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
        receiveButton->setProperty("text", QVariant(QApplication::translate("ReceiveCoinsDialog", "Generate Address", Q_NULLPTR)));
#ifndef QT_NO_TOOLTIP
        clearButton->setToolTip(QApplication::translate("ReceiveCoinsDialog", "Clear all fields of the form.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        clearButton->setProperty("text", QVariant(QApplication::translate("ReceiveCoinsDialog", "Clear", Q_NULLPTR)));
...
#endif // QT_NO_TOOLTIP
        showRequestButton->setProperty("text", QVariant(QApplication::translate("ReceiveCoinsDialog", "Show", Q_NULLPTR)));
#ifndef QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
        removeRequestButton->setProperty("text", QVariant(QApplication::translate("ReceiveCoinsDialog", "Remove", Q_NULLPTR)));
