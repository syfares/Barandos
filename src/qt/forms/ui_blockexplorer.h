...
public:
    ...
    QtMaterialFlatButton *back;
    QtMaterialFlatButton *forward;
    QLineEdit *searchBox;
    QtMaterialFlatButton *pushSearch;
    ...
    void setupUi(QMainWindow *BlockExplorer)
    {
        ...
        back = new QtMaterialFlatButton(centralwidget);
        ...
        forward = new QtMaterialFlatButton(centralwidget);
        ...
        pushSearch = new QtMaterialFlatButton(centralwidget);
