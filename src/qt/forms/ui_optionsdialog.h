...
public:
    ...
    QtMaterialFlatButton *resetButton;
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        anonymizebarandos = new QSpinBox(tabMain);
        anonymizebarandos->setObjectName(QStringLiteral("anonymizebarandos"));
        anonymizebarandos->setMinimum(100);
        anonymizebarandos->setMaximum(100000);
        anonymizebarandos->setSingleStep(100);
        anonymizebarandos->setValue(1000);

        horizontalLayout->addWidget(anonymizebarandos);
        ...
        showOrphans = new QCheckBox(groupBox);
        showOrphans->setObjectName(QStringLiteral("showOrphans"));

        verticalLayout_2->addWidget(showOrphans);
        ...
        resetButton = new QtMaterialFlatButton(OptionsDialog);
        resetButton->setObjectName(QStringLiteral("resetButton"));
        resetButton->setProperty("autoDefault", QVariant(false));
        ...
        okButton = new QtMaterialFlatButton(OptionsDialog);
        okButton->setObjectName(QStringLiteral("okButton"));
        okButton->setProperty("autoDefault", QVariant(false));
        okButton->setProperty("default", QVariant(true));

        horizontalLayout_Buttons->addWidget(okButton);

        cancelButton = new QtMaterialFlatButton(OptionsDialog);
    ...
    void retranslateUi(QDialog *OptionsDialog)
    {
...
#ifndef QT_NO_TOOLTIP
        bitcoinAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start barandos after logging in to the system.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        bitcoinAtStartup->setText(QApplication::translate("OptionsDialog", "&Start barandos on system login", Q_NULLPTR));
...
#endif // QT_NO_TOOLTIP
        label_2->setText(QApplication::translate("OptionsDialog", "Amount of barandos to keep anonymized", Q_NULLPTR));
        ...
        showOrphans->setText(QApplication::translate("OptionsDialog", "Filter Orphans from Transaction History", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tabWallet), QApplication::translate("OptionsDialog", "W&allet", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the barandos client port on the router. This only works when your router supports UPnP and it is enabled.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the barandos network through a SOCKS5 proxy.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        lang->setToolTip(QApplication::translate("OptionsDialog", "The user interface language can be set here. This setting will take effect after restarting barandos.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
"https://www.transifex.com/barandos-project/barandos-project-translations", Q_NULLPTR));
...
#endif // QT_NO_TOOLTIP
        resetButton->setProperty("text", QVariant(QApplication::translate("OptionsDialog", "Reset Options", Q_NULLPTR)));
        statusLabel->setText(QString());
        okButton->setProperty("text", QVariant(QApplication::translate("OptionsDialog", "OK", Q_NULLPTR)));
        cancelButton->setProperty("text", QVariant(QApplication::translate("OptionsDialog", "Cancel", Q_NULLPTR)));
    } // retranslateUi
