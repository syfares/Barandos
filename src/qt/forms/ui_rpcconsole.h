...
public:
    ...
    QtMaterialFlatButton *openDebugLogfileButton;
    QWidget *tab_console;
    ...
    QtMaterialFlatButton *btnClearTrafficGraph;
    ...
    void setupUi(QDialog *RPCConsole)
    {
        ...
        openDebugLogfileButton = new QtMaterialFlatButton(tab_info);
        openDebugLogfileButton->setObjectName(QStringLiteral("openDebugLogfileButton"));
        openDebugLogfileButton->setProperty("autoDefault", QVariant(false));
        ...
        clearButton = new QtMaterialFlatButton(tab_console);
        clearButton->setObjectName(QStringLiteral("clearButton"));
        clearButton->setMaximumSize(QSize(24, 24));
        QIcon icon;
        icon.addFile(QStringLiteral(":/icons/remove"), QSize(), QIcon::Normal, QIcon::Off);
        clearButton->setProperty("icon", QVariant(icon));
        clearButton->setProperty("shortcut", QVariant(QStringLiteral("Ctrl+L")));
        ...
        btnClearTrafficGraph = new QtMaterialFlatButton(tab_nettraffic);
        btnClearTrafficGraph->setObjectName(QStringLiteral("btnClearTrafficGraph"));
        btnClearTrafficGraph->setProperty("autoDefault", QVariant(false));
        ...
        banlistWidget->setContextMenuPolicy(Qt::CustomContextMenu);
        ...
        btn_salvagewallet = new QtMaterialFlatButton(tab_repair);
        ...
        btn_rescan = new QtMaterialFlatButton(tab_repair);
        ...
        btn_zapwallettxes1 = new QtMaterialFlatButton(tab_repair);
        ...
        btn_zapwallettxes2 = new QtMaterialFlatButton(tab_repair);
        ...
        btn_upgradewallet = new QtMaterialFlatButton(tab_repair);
        ...
        btn_reindex = new QtMaterialFlatButton(tab_repair);
    ...
    void retranslateUi(QDialog *RPCConsole)
    {
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the BARA debug log file from the current data directory. This can take a few seconds for large log files.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        openDebugLogfileButton->setProperty("text", QVariant(QApplication::translate("RPCConsole", "Open", Q_NULLPTR)));
...
#endif // QT_NO_TOOLTIP
        clearButton->setProperty("text", QVariant(QString()));
        tabWidget->setTabText(tabWidget->indexOf(tab_console), QApplication::translate("RPCConsole", "&Console", Q_NULLPTR));
        btnClearTrafficGraph->setProperty("text", QVariant(QApplication::translate("RPCConsole", "Clear", Q_NULLPTR)));
        ...
        btn_salvagewallet->setProperty("text", QVariant(QApplication::translate("RPCConsole", "Salvage wallet", Q_NULLPTR)));
        ...
        btn_rescan->setProperty("text", QVariant(QApplication::translate("RPCConsole", "Rescan blockchain files", Q_NULLPTR)));
        ...
        btn_zapwallettxes1->setProperty("text", QVariant(QApplication::translate("RPCConsole", "Recover transactions 1", Q_NULLPTR)));
        ...
        btn_zapwallettxes2->setProperty("text", QVariant(QApplication::translate("RPCConsole", "Recover transactions 2", Q_NULLPTR)));
        ...
        btn_upgradewallet->setProperty("text", QVariant(QApplication::translate("RPCConsole", "Upgrade wallet format", Q_NULLPTR)));
        ...
        btn_reindex->setProperty("text", QVariant(QApplication::translate("RPCConsole", "Rebuild index", Q_NULLPTR)));
