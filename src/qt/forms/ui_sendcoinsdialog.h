...
public:
    ...
    QtMaterialFlatButton *pushButtonCoinControl;
    ...
    QtMaterialFlatButton *buttonChooseFee;
    QtMaterialFlatButton *buttonMinimizeFee;
    ...
    QtMaterialFlatButton *clearButton;
    QtMaterialFlatButton *addButton;
    ...
    void setupUi(QDialog *SendCoinsDialog)
    {
        ...
        pushButtonCoinControl = new QtMaterialFlatButton(frameCoinControl);
        ...
        pushButtonCoinControl->setProperty("autoDefault", QVariant(false));
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 BARA"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 BARA"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 BARA"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 BARA"));
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 830, 161));
        ...
        sendButton = new QtMaterialFlatButton(SendCoinsDialog);
        sendButton->setObjectName(QStringLiteral("sendButton"));
        sendButton->setMinimumSize(QSize(150, 0));
        QIcon icon;
        icon.addFile(QStringLiteral(":/icons/send"), QSize(), QIcon::Normal, QIcon::Off);
        sendButton->setProperty("icon", QVariant(icon));
        sendButton->setProperty("autoDefault", QVariant(false));
        sendButton->setProperty("default", QVariant(true));

        horizontalLayout->addWidget(sendButton);

        clearButton = new QtMaterialFlatButton(SendCoinsDialog);
        ...
        clearButton->setProperty("icon", QVariant(icon1));
        clearButton->setProperty("autoDefault", QVariant(false));

        horizontalLayout->addWidget(clearButton);

        addButton = new QtMaterialFlatButton(SendCoinsDialog);
        addButton->setObjectName(QStringLiteral("addButton"));
        QIcon icon2;
        icon2.addFile(QStringLiteral(":/icons/add"), QSize(), QIcon::Normal, QIcon::Off);
        addButton->setProperty("icon", QVariant(icon2));
        addButton->setProperty("autoDefault", QVariant(false));
        ...
        labelBalance->setText(QStringLiteral("123.456 BARA"));
    ...
    void retranslateUi(QDialog *SendCoinsDialog)
    {
        ...
        pushButtonCoinControl->setProperty("text", QVariant(QApplication::translate("SendCoinsDialog", "Inputs...", Q_NULLPTR)));
        ...
        labelBlockSize->setText(QApplication::translate("SendCoinsDialog", "0 BARA", Q_NULLPTR));
        ...
        buttonChooseFee->setProperty("text", QVariant(QApplication::translate("SendCoinsDialog", "Choose...", Q_NULLPTR)));
#ifndef QT_NO_TOOLTIP
        buttonMinimizeFee->setToolTip(QApplication::translate("SendCoinsDialog", "collapse fee-settings", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        buttonMinimizeFee->setProperty("text", QVariant(QApplication::translate("SendCoinsDialog", "Minimize", Q_NULLPTR)));
#ifndef QT_NO_TOOLTIP
        radioCustomPerKilobyte->setToolTip(QApplication::translate("SendCoinsDialog", "If the custom fee is set to 1000 uBARAs and the transaction is only 250 bytes, then \"per kilobyte\" only pays 250 uBARAs in fee,<br />while \"at least\" pays 1000 uBARAs. For transactions bigger than a kilobyte both pay by kilobyte.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        radioCustomPerKilobyte->setText(QApplication::translate("SendCoinsDialog", "per kilobyte", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        radioCustomAtLeast->setToolTip(QApplication::translate("SendCoinsDialog", "If the custom fee is set to 1000 uBARAs and the transaction is only 250 bytes, then \"per kilobyte\" only pays 250 uBARAs in fee,<br />while \"total at least\" pays 1000 uBARAs. For transactions bigger than a kilobyte both pay by kilobyte.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        radioCustomAtLeast->setText(QApplication::translate("SendCoinsDialog", "total at least", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        checkBoxMinimumFee->setToolTip(QApplication::translate("SendCoinsDialog", "Paying only the minimum fee is just fine as long as there is less transaction volume than space in the blocks.<br />But be aware that this can end up in a never confirming transaction once there is more demand for barandos transactions than the network can process.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        checkBoxMinimumFee->setText(QString());
#ifndef QT_NO_TOOLTIP
        labelMinFeeWarning->setToolTip(QApplication::translate("SendCoinsDialog", "Paying only the minimum fee is just fine as long as there is less transaction volume than space in the blocks.<br />But be aware that this can end up in a never confirming transaction once there is more demand for barandos transactions than the network can process.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
        sendButton->setProperty("text", QVariant(QApplication::translate("SendCoinsDialog", "Send", Q_NULLPTR)));
#ifndef QT_NO_TOOLTIP
        clearButton->setToolTip(QApplication::translate("SendCoinsDialog", "Clear all fields of the form.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        clearButton->setProperty("text", QVariant(QApplication::translate("SendCoinsDialog", "Clear All", Q_NULLPTR)));
#ifndef QT_NO_TOOLTIP
        addButton->setToolTip(QApplication::translate("SendCoinsDialog", "Send to multiple recipients at once", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        addButton->setProperty("text", QVariant(QApplication::translate("SendCoinsDialog", "Add Recipient", Q_NULLPTR)));
        checkUseObfuscation->setText(QApplication::translate("SendCoinsDialog", "Obfuscation", Q_NULLPTR));
        checkSwiftTX->setText(QApplication::translate("SendCoinsDialog", "SwiftTX", Q_NULLPTR));
