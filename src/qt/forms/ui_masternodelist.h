...
public:
    ...
    QtMaterialFlatButton *startButton;
    QtMaterialFlatButton *startAllButton;
    QtMaterialFlatButton *startMissingButton;
    QtMaterialFlatButton *UpdateButton;
    ...
    void retranslateUi(QWidget *MasternodeList)
    {
        ...
        startButton->setText(QApplication::translate("MasternodeList", "Start alias", Q_NULLPTR));
