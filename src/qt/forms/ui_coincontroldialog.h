...
public:
    ...
    QtMaterialFlatButton *pushButtonSelectAll;
    QtMaterialFlatButton *pushButtonToggleLock;
    ...
    QtMaterialFlatButton *selectButton;
    ...
    void setupUi(QDialog *CoinControlDialog)
    {
        ...
        pushButtonSelectAll = new QtMaterialFlatButton(frame);
        ...
        pushButtonSelectAll->setProperty("autoDefault", QVariant(false));

        horizontalLayoutPanel->addWidget(pushButtonSelectAll);

        pushButtonToggleLock = new QtMaterialFlatButton(frame);
        ...
        pushButtonToggleLock->setProperty("autoDefault", QVariant(false));
        ...
        selectButton = new QtMaterialFlatButton(CoinControlDialog);
    ...
    void retranslateUi(QDialog *CoinControlDialog)
    {
        ...
        pushButtonSelectAll->setProperty("text", QVariant(QApplication::translate("CoinControlDialog", "(un)select all", Q_NULLPTR)));
        pushButtonToggleLock->setProperty("text", QVariant(QApplication::translate("CoinControlDialog", "toggle lock state", Q_NULLPTR)));
...
#endif // QT_NO_TOOLTIP
        selectButton->setProperty("text", QVariant(QApplication::translate("CoinControlDialog", "OK", Q_NULLPTR)));
    } // retranslateUi
