...
#include "qt/qtmaterialstatetransition.h"
...
const QMetaObject QtMaterialStateTransition::staticMetaObject = {
    { &QAbstractTransition::staticMetaObject, qt_meta_stringdata_QtMaterialStateTransition.data,
      qt_meta_data_QtMaterialStateTransition,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QtMaterialStateTransition::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QtMaterialStateTransition.stringdata0))
        return static_cast<void*>(const_cast< QtMaterialStateTransition*>(this));
