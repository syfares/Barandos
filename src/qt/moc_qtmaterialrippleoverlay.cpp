...
#include "qt/qtmaterialrippleoverlay.h"
...
const QMetaObject QtMaterialRippleOverlay::staticMetaObject = {
    { &QtMaterialOverlayWidget::staticMetaObject, qt_meta_stringdata_QtMaterialRippleOverlay.data,
      qt_meta_data_QtMaterialRippleOverlay,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QtMaterialRippleOverlay::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QtMaterialRippleOverlay.stringdata0))
        return static_cast<void*>(const_cast< QtMaterialRippleOverlay*>(this));
