...
/** Utility functions used by the barandos Qt UI.
 */
namespace GUIUtil
{
...
// Render barandos addresses in monospace font
...
// Parse "barandos:" URI into recipient object, return true on successful parsing
