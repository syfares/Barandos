...
const QMetaObject QtMaterialTheme::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QtMaterialTheme.data,
      qt_meta_data_QtMaterialTheme,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QtMaterialTheme::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QtMaterialTheme.stringdata0))
        return static_cast<void*>(const_cast< QtMaterialTheme*>(this));
