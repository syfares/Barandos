...
QT_MOC_LITERAL(5, 63, 30), // "anonymizebarandosAmountChanged"
QT_MOC_LITERAL(6, 94, 26) // "coinControlFeaturesChanged"

    },
    "OptionsModel\0displayUnitChanged\0\0unit\0"
    "obfuscationRoundsChanged\0"
    "anonymizebarandosAmountChanged\0"
...
void OptionsModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->anonymizebarandosAmountChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        {
            typedef void (OptionsModel::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&OptionsModel::anonymizebarandosAmountChanged)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 2
void OptionsModel::anonymizebarandosAmountChanged(int _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
