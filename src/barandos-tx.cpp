...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("barandos Core barandos-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  barandos-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded barandos transaction") + "\n" +
                               "  barandos-tx [options] -create [commands]   " + _("Create hex-encoded barandos transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded barandos transaction
